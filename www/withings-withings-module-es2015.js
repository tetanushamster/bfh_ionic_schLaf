...
const routes = [
    ...
    {
        path: 'identity',
        loadChildren: () => __webpack_require__.e(/*! import() | identity-identity-module */ "identity-identity-module").then(__webpack_require__.bind(null, /*! ./identity/identity.module */ "./src/app/withings/identity/identity.module.ts")).then(m => m.IdentityPageModule)
    },
    {
        path: 'data',
        loadChildren: () => __webpack_require__.e(/*! import() | data-data-module */ "data-data-module").then(__webpack_require__.bind(null, /*! ./data/data.module */ "./src/app/withings/data/data.module.ts")).then(m => m.DataPageModule)
    }
];
let WithingsPageRoutingModule = class WithingsPageRoutingModule {
};
...
let WithingsPageModule = class WithingsPageModule {
};
...
let WithingsPage = class WithingsPage {
    constructor() { }
    ngOnInit() {
    }
};
...
//# sourceMappingURL=withings-withings-module-es2015.js.map