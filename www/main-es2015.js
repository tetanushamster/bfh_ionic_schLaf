...
const routes = [
    ...
    {
        path: 'choice-login',
        loadChildren: () => __webpack_require__.e(/*! import() | choice-login-choice-login-module */ "choice-login-choice-login-module").then(__webpack_require__.bind(null, /*! ./choice-login/choice-login.module */ "./src/app/choice-login/choice-login.module.ts")).then(m => m.ChoiceLoginPageModule)
    },
    {
        path: 'register',
    ...
    },
    {
        ...
        loadChildren: () => __webpack_require__.e(/*! import() | protocol-protocol-module */ "protocol-protocol-module").then(__webpack_require__.bind(null, /*! ./protocol/protocol.module */ "./src/app/protocol/protocol.module.ts")).then(m => m.ProtocolPageModule)
    },
    {
        path: 'questions',
        //canActivate: [AuthGuard],
        loadChildren: () => __webpack_require__.e(/*! import() | questions-questions-module */ "questions-questions-module").then(__webpack_require__.bind(null, /*! ./questions/questions.module */ "./src/app/questions/questions.module.ts")).then(m => m.QuestionsPageModule)
    },
    {
        path: 'window',
        //canActivate: [AuthGuard],
        loadChildren: () => __webpack_require__.e(/*! import() | window-window-module */ "window-window-module").then(__webpack_require__.bind(null, /*! ./window/window.module */ "./src/app/window/window.module.ts")).then(m => m.WindowPageModule)
    },
    {
        path: 'records',
        //canActivate: [AuthGuard],
        loadChildren: () => __webpack_require__.e(/*! import() | records-records-module */ "records-records-module").then(__webpack_require__.bind(null, /*! ./records/records.module */ "./src/app/records/records.module.ts")).then(m => m.RecordsPageModule)
    },
    {
        path: 'information',
        //canActivate: [AuthGuard],
        loadChildren: () => __webpack_require__.e(/*! import() | information-information-module */ "information-information-module").then(__webpack_require__.bind(null, /*! ./information/information.module */ "./src/app/information/information.module.ts")).then(m => m.InformationPageModule)
    },
    {
        path: 'withings',
        loadChildren: () => __webpack_require__.e(/*! import() | withings-withings-module */ "withings-withings-module").then(__webpack_require__.bind(null, /*! ./withings/withings.module */ "./src/app/withings/withings.module.ts")).then(m => m.WithingsPageModule)
    }
];
...
/* harmony import */ var _angular_common_locales_de_CH__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! @angular/common/locales/de-CH */ "./node_modules/@angular/common/locales/de-CH.js");
/* harmony import */ var _angular_common_locales_de_CH__WEBPACK_IMPORTED_MODULE_10___default = /*#__PURE__*/__webpack_require__.n(_angular_common_locales_de_CH__WEBPACK_IMPORTED_MODULE_10__);
...
Object(_angular_common__WEBPACK_IMPORTED_MODULE_9__["registerLocaleData"])(_angular_common_locales_de_CH__WEBPACK_IMPORTED_MODULE_10___default.a, 'de');
...
AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        ...
        imports: [
            ...
            _angular_fire__WEBPACK_IMPORTED_MODULE_13__["AngularFireModule"].initializeApp(src_environments_environment__WEBPACK_IMPORTED_MODULE_14__["environment"].firebase, 'bhf_ionic_schlaf'),
...
module.exports = __webpack_require__(/*! C:\Users\Elly2178\Downloads\MedInfo\In\Semestrul 9\Klinical apps for tablets\bfh_ionic_schLaf\src\main.ts */"./src/main.ts");
