...
var QuestionsPageRoutingModule = /** @class */ (function () {
    function QuestionsPageRoutingModule() {
    }
...
var QuestionsPage = /** @class */ (function () {
    function QuestionsPage(firestore, router) {
    ...
    QuestionsPage.prototype.logForm = function (form) {
        var _this = this;
        return new Promise(function (resolve, reject) {
            _this.firestore
                ...
                user: 'dummy', time: _this.now })
                .then(function (res) { _this.router.navigateByUrl('/protocol'); }, function (err) { return reject(err); });
        });
    };
    QuestionsPage.ctorParameters = function () { return [
